    ...
    <thead>
      ...
      <?php 
        ...
        <tr>
            ...
            <td class="text-center"><a href="cart.php?action=update&id=<?php echo $value['game_id'];?>"><span>Update</span></a><br><br><a href="cart.php?action=delete&id=<?php echo $value['game_id'];?>"><span>Remove</span></a></td>
        </tr>
        <?php
        $total = $total + ($value['game_quantity'] * $value['game_price']);
          ...
          <td colspan="5" class="text-left"><a href="../pages/games.php">Back to game store</a></td>
